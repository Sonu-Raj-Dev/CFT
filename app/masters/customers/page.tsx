...
const filtered = useMemo(
  () =>
    customers?.data?.filter((c) =>
      [c.customerName, c.mobileNumber, c.email, c.address]
        .join(" ")
        .toLowerCase()
                      ...
                      <TableRow key={c.id}>
                        ...
                        <TableCell className="text-right">
                          <Button
                            ...
                            onClick={() => updateCustomer(c.id, { name: c.customerName })}
                          >
                            Edit
                          </Button>
                ...
                {filtered.map((c) => (
                  <div key={c.id} className="border rounded-lg p-4">
                    ...
                    <div className="mt-3 flex gap-2">
                      <Button size="sm" variant="outline" onClick={() => updateCustomer(c.id, { name: c.customerName })}>
                        Edit
                      </Button>
